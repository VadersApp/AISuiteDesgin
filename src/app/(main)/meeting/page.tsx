    ...
    return (
        <div className="space-y-8 h-[calc(100vh-8rem)] flex flex-col">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 flex-1 min-h-0">
                <div className="bg-[#1E293B]/70 border border-slate-700/50 rounded-2xl p-4 flex flex-col overflow-hidden">
                    ...
                    <div className="space-y-2 overflow-y-auto custom-scrollbar pr-1">
                        {bots.map(b => (
                             <button key={b.id} className="w-full flex items-center gap-3 p-2.5 rounded-xl border border-slate-700/50 text-slate-400 hover:border-slate-600 bg-slate-800/20 hover:bg-slate-800 transition-all group">
                ...
                <div className="lg:col-span-3 bg-[#1E293B]/40 border border-slate-700/50 rounded-2xl flex flex-col overflow-hidden">
                    ...
                    <div className="p-4 border-t border-slate-700/50 bg-slate-900/40 flex gap-3">
                        <input type="text" placeholder="Sprechen oder schreiben..." className="flex-1 bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500 transition-colors" />
