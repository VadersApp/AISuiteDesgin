        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-[#1E293B]/50 border border-slate-700/50 rounded-2xl relative shadow-2xl">
            ...
            <div className="flex-1 overflow-y-auto p-8 pt-6 space-y-6 custom-scrollbar" id="chat-messages">
                <div className="flex justify-start">
                    <div className="max-w-[85%] md:max-w-[70%] p-4 rounded-2xl text-sm bg-slate-800/80 text-slate-200 border border-slate-700 rounded-tl-none">Willkommen bei der QORE Kommunikation. Wie kann ich heute helfen?</div>
                </div>
            </div>
            <div className="p-4 bg-slate-900/30 border-t border-slate-700/50">
                <div className="max-w-4xl mx-auto flex gap-3">
                    <input type="text" id="chat-input" placeholder="Frag deine QORE..." className="flex-1 bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500 transition-colors" onKeyDown={(e) => e.key === 'Enter' && sendMessage()} />
