...
export default function MainLayout({ children }: PropsWithChildren) {
  return (
    <SidebarProvider>
      <Sidebar className="w-72 border-r-0 bg-[#0F1C2F] [background:linear-gradient(to_bottom,_#12233A,_#080E1A)] flex flex-col transition-all duration-300 z-50 flex-shrink-0">
        <MainNav />
      </Sidebar>
